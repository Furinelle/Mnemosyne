...
mnemosyne search "<task keywords>" --format json --limit 5
```
...
A consumer must run `mnemosyne codex-ingest --source codex --commit` to save these blocks. Do not claim automatic memory injection or successful ingestion without evidence.
